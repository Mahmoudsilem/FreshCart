...
<Helmet>
    ...
    <form onSubmit={formk.handleSubmit}>
      <div className='w-[70%] mx-auto pt-3'>
        <h1 className='text-green-950 mb-3'>Register Now:</h1>
        ...
        <p className=' ms-1 py-2'>Already have an account? <span className='font-medium'><Link to="/login">Login Now</Link></span></p>

        <button className='btn-outline w-full text-base' type='submit'>Register</button>
      </div>
    </form>
  </>
}
